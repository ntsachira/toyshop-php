...
$product_count_result = Database::execute("SELECT * FROM `product` WHERE `quantity` BETWEEN 1 AND 5 ");
...
?>
<div class="fs-6 fw-semibold mb-2">LIMITED STOCK PRODUCTS (<?php echo $product_count ?>)</div>
                    <div class="row " >
...
<div class="ui items" style="margin-top:-1rem">
    ...
    if ($invoice_result->num_rows != 0) { //* checking if invoices are available                           
        ...
        $product_result = Database::execute("SELECT * FROM `product` WHERE `quantity` BETWEEN 1 AND 5 ORDER BY `quantity` ASC LIMIT $product_per_page 
                                    ...
                                    <nav aria-label="...">
                                        <ul class="pagination">
                                            ...
                                            if($page_no > 1){
                                                ...
                                                <a onclick="loadLimitedStock(<?php echo $page_no-1 ?>)" 
                                                ...
                                                for($i = 1; $i <= $number_of_pages; $i++){
                                                    if($page_no == $i){
                                                        ...
                                                        onclick="loadLimitedStock(<?php echo $i ?>)"><?php echo $i ?></a></li>
                                                        <?php
                                                    }
                                                }
