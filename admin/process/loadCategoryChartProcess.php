...
$category_result = Database::execute("SELECT `category_id`,`category_name`,SUM(invoice_item_quantity) AS `product_count` 
...
if ($category_result->num_rows > 0) {
    ...
    while ($category_data = $category_result->fetch_assoc()) {
        ...
        if ($category_data['product_count'] != 0) {
            ...
            $categories->count = $category_data['product_count'];
